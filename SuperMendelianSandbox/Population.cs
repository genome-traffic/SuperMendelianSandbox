...
namespace SMS
{
    class Population
    {
        ...
        //new WT population
        public Population(int numberF, int numberM)
        {
            this.Adults = new List<Organism>();
            this.Eggs = new List<Organism>();
        ...
        public Organism GenerateWTFemale()
        {
            ...
            ZPGa.AddToTraits("HomRepair_male", 0.96F);
            ZPGa.AddToTraits("HomRepair_female", 0.96F);

            GeneLocus ZPGb = new GeneLocus("ZPG", 1F, "WT");
            ZPGb.AddToTraits("Conservation", 0.95F);
            ZPGb.AddToTraits("HomRepair_male", 0.96F);
            ZPGb.AddToTraits("HomRepair_female", 0.96F);

            GeneLocus Aper1a = new GeneLocus("Aper1", 2F, "WT");
            Aper1a.AddToTraits("Conservation", 0.95F);
            Aper1a.AddToTraits("HomRepair_male", 0.96F);
            Aper1a.AddToTraits("HomRepair_female", 0.96F);

            GeneLocus Aper1b = new GeneLocus("Aper1", 2F, "WT");
            Aper1b.AddToTraits("Conservation", 0.95F);
            Aper1b.AddToTraits("HomRepair_male", 0.96F);
            Aper1b.AddToTraits("HomRepair_female", 0.96F);

            GeneLocus AP2a = new GeneLocus("AP2", 3F, "WT");
            AP2a.AddToTraits("Conservation", 0.95F);
            AP2a.AddToTraits("HomRepair_male", 0.96F);
            AP2a.AddToTraits("HomRepair_female", 0.96F);

            GeneLocus AP2b = new GeneLocus("AP2", 3F, "WT");
            AP2b.AddToTraits("Conservation", 0.95F);
            AP2b.AddToTraits("HomRepair_male", 0.96F);
            AP2b.AddToTraits("HomRepair_female", 0.96F);

            GeneLocus CPa = new GeneLocus("CP", 1F, "WT");
            CPa.AddToTraits("Conservation", 0.95F);
            CPa.AddToTraits("HomRepair_male", 0.96F);
            CPa.AddToTraits("HomRepair_female", 0.96F);

            GeneLocus CPb = new GeneLocus("CP", 1F, "WT");
            CPb.AddToTraits("Conservation", 0.95F);
            CPb.AddToTraits("HomRepair_male", 0.96F);
            CPb.AddToTraits("HomRepair_female", 0.96F);
        ...
        public Organism GenerateZPG_DriveMale()
        {
            ...
            ZPG_d.AddToTraits("HomRepair_male", 0.96F);
            ZPG_d.AddToTraits("HomRepair_female", 0.96F);
        ...
        public Organism GenerateZPG_Aper1_DriveMale()
        {
            ...
            Aper1_d.AddToTraits("HomRepair_male", 0.96F);
            Aper1_d.AddToTraits("HomRepair_female", 0.96F);
        ...
        public Organism GenerateZPG_CP_DriveMale()
        {
            ...
            CP_d.AddToTraits("HomRepair_male", 0.96F);
            CP_d.AddToTraits("HomRepair_female", 0.96F);
        ...
        public Organism GenerateZPG_AP2_DriveMale()
        {
            ...
            AP2_d.AddToTraits("HomRepair_male", 0.96F);
            AP2_d.AddToTraits("HomRepair_female", 0.96F);
